...
class Player(BasePlayer):
    ...
    understand_rules = models.BooleanField(label='I confirm that I understand the rules of the game.',
                                           widget=widgets.CheckboxInput)
    understand_drop = models.BooleanField(
        label='I understand that if another participant leaves the study, then my participation will also end.',
        widget=widgets.CheckboxInput)
